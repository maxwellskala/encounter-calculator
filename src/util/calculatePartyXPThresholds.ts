type levelToXpThreshold = {
  [key: number]: number;
};

const LEVEL_TO_EASY_XP_THRESHOLD: levelToXpThreshold = {
  1: 25,
  2: 50,
  3: 75,
  4: 125,
...
const LEVEL_TO_MEDIUM_XP_THRESHOLD: levelToXpThreshold = {
  1: 50,
  2: 100,
  3: 150,
  4: 250,
...
const LEVEL_TO_HARD_XP_THRESHOLD: levelToXpThreshold = {
  1: 75,
  2: 150,
  3: 225,
  4: 375,
...
const LEVEL_TO_DEADLY_XP_THRESHOLD: levelToXpThreshold = {
  1: 100,
  2: 200,
  3: 400,
  4: 500,
...
const calculatePartyXPThresholds = (
  ...
  return {
    ...
    hard: LEVEL_TO_HARD_XP_THRESHOLD[level] * count,
